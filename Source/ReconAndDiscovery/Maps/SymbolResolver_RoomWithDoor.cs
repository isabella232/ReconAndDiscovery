...
namespace ReconAndDiscovery.Maps
{
	public class SymbolResolver_RoomWithDoor : SymbolResolver
	{
		...
		{
            if (rp.TryGetCustom<char[]>("hasDoor", out char[] array))
            {
            ...
            rp.TryGetCustom<float>("madAnimalChance", out float chance);
            rp.TryGetCustom<float>("luciferiumGasChance", out float chance2);
            rp.TryGetCustom<float>("psionicLandmineChance", out float chance3);
            rp.TryGetCustom<float>("smallGoldChance", out float chance4);
            rp.TryGetCustom<float>("smallSilverChance", out float chance5);
